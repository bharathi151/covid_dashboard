"""
Raise exception when invalid cases details given
"""
...
class TestCase04UpdateCasesDeatilsAPITestCase(CustomAPITestCase):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase04UpdateCasesDeatilsAPITestCase, self).setupUser(
