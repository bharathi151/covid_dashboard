"""
Raise mandal id Exception when mandal id is invalid
"""
...
class TestCase03UpdateCasesDeatilsAPITestCase(CustomAPITestCase):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase03UpdateCasesDeatilsAPITestCase, self).setupUser(
