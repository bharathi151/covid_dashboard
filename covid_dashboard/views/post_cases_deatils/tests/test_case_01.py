"""
Post cases details with valid given details
"""
...
class TestCase01PostCasesDeatilsAPITestCase(CustomAPITestCase):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase01PostCasesDeatilsAPITestCase, self).setupUser(
