...
class TestCase01GetDistrictsCumulativeReportDayWiseAPITestCase(CustomAPITestCase):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase01GetDistrictsCumulativeReportDayWiseAPITestCase, self).setupUser(
