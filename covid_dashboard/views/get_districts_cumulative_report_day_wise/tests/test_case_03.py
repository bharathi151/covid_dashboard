...
class TestCase03GetDistrictsCumulativeReportDayWiseAPITestCase(CustomAPITestCase):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase03GetDistrictsCumulativeReportDayWiseAPITestCase, self).setupUser(
        ...
        CasesDetailsFactory.create(mandal=mandal_1, date="2020-06-26",
                                   confirmed_cases=15,
                                   recovered_cases=3,
                                   deaths=0)
